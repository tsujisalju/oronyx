  ...
  const filteredAgents = useMemo(() => {
    ...
    switch (sortOption) {
      ...
      case "risk-high":
        result.sort(
          (a, b) =>
            b.riskThreshold - a.riskThreshold,
        );
        break;
      ...
      case "risk-low":
        result.sort(
          (a, b) =>
            a.riskThreshold - b.riskThreshold,
        );
        break;
      ...
      case "balance-high":
        result.sort(
          (a, b) =>
            getVaultBalance(b.vaultBalance) -
            getVaultBalance(a.vaultBalance),
        );
        break;
...
/>
          ...
          <Empty className="mt-10 border border-dashed">
            <EmptyHeader>
              ...
              <EmptyDescription>
                You need a wallet to use Oronyx. Connect a
                wallet or log in to get started.
              </EmptyDescription>
