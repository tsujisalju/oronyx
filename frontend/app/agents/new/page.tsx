...
export default function NewAgentPage() {
  ...
  async function handleCreateAgent() {
    ...
    const newAgent: Agent = {
      ...
      spendingLimit:
        `${numericSpendingLimit.toFixed(2)} SUI`,

      allowedActions:
        selectedActions,

      periodLimit:
        `${numericPeriodLimit.toFixed(2)} SUI`,
      ...
      <div className="mx-auto max-w-3xl px-8 py-10">
        ...
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Configure the permissions and limits
            that control your agent.
          </p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Define what this agent is
                  allowed to do and how much
                  authority it has.
                </CardDescription>
              </div>
            </div>
  ...
  if (typeof value === "string") {
    setPeriodLength(value);
              ...
              <p className="text-xs text-muted-foreground">
                The spending limit resets after
                this period.
              </p>
            </div>
  ...
  <div className="flex justify-between text-xs text-muted-foreground">
    ...
    <span>100%</span>
            ...
            <div className="grid gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                The agent policy becomes invalid
                after this duration.
              </p>
            </div>
        ...
        {created && (
          <Card className="mt-8 border-emerald-500/30 bg-emerald-500/5">
            <CardHeader>
              ...
              <CardDescription>
                {agentName} has been saved locally
