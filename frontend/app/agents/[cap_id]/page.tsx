...
export default function AgentPage() {
  ...
  const currentBalance =
    Number.parseFloat(agent.vaultBalance) || 0;
        ...
        <div className="mx-auto max-w-5xl px-8 py-10">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                The requested agent does not exist in the current
                mock data.
              </CardDescription>
            </CardHeader>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              Its current policy and vault information will be preserved.
            </AlertDialogDescription>
          </AlertDialogHeader>
      ...
      <AlertDialog key="activate-dialog">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This agent will be allowed to perform autonomous actions again
